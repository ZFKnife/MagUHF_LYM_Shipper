package com.fxb.shipper.myapplication.util;

import android.content.Context;
import android.media.AudioManager;
import android.media.SoundPool;

import com.fxb.shipper.myapplication.R;
...
public class DevBeep {
	...
	public static  void init(Context ct)
	{
		...
		//if(soundPool == null)
		{
			...
			sound_okID = soundPool.load(ct.getApplicationContext(), R.raw.beep_ok,1);
		   //sound_okID = soundPool.load("/sdcard/beep_ok.wav", 1);
			
			sound_errID = soundPool.load(ct.getApplicationContext(), R.raw.beep_err, 1);
		}
	}
