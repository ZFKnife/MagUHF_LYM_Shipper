...
public class MagicMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_btnread.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                intentTo.setClass(MagicMainActivity.this, ShipperWriteActivity.class);
                startActivity(intentTo);
            }
        });
        m_set_shipper.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(MagicMainActivity.this, SelectShipperActivity.class);
    ...
    private void Initview() {
        ...
        m_set_shipper = (Button) findViewById(R.id.set_shipper);
